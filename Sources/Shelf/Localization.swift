...
enum StringKey: String {
    ...
    case headerKeepOpen = "header.keepOpen"
    case headerStopKeepingOpen = "header.stopKeepingOpen"
    case searchPlaceholder = "search.placeholder"
    case searchEmpty = "search.empty"
    case dropHint = "drop.hint"
    case chooseCount = "choose.count"
    case chooseCopy = "choose.copy"
    case chooseDelete = "choose.delete"
    case chooseClear = "choose.clear"
    case chooseHint = "choose.hint"
    ...
    case menuBackground = "menu.background"
    case tintTeal = "tint.teal"
    case tintAmber = "tint.amber"
    case tintViolet = "tint.violet"
    case tintRose = "tint.rose"
    case tintSlate = "tint.slate"
    case backgroundSystem = "background.system"
    case backgroundCharcoal = "background.charcoal"
    case backgroundMidnight = "background.midnight"
    ...
    case menuReinstall = "menu.reinstall"
    ...
    case animationRubber = "animation.rubber"
    case animationUnfold = "animation.unfold"
    case menuEdgeOpenMode = "menu.edgeOpenMode"
    case edgeModePush = "edgeMode.push"
    case edgeModeDrag = "edgeMode.drag"
